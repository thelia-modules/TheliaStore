...
return array(
    ...
    'TextModalLogin %url' => '<p>Vous devez être connecté pour essayer et/ou acquerir des modules</p> <p>Si vous n\'avez pas encore de compte, <a href="%url">créez en un maintenant !</a></p>',
    ...
    'No comments for this extension' => 'Aucun commentaire pour cette extension',
